...
#Set the input and output files for MASTRANC
#Customer file
export CUSTMAST=RSD-/home/db2inst1/CUSTMAST
#Unloaded transaction file
export TRANFILE=RSD-/home/db2inst1/Tab.txt
#Report file
export OUTFILE=RSD-/home/db2inst1/OUTPUT-INSURE.txt
#Execute MASTRANC to produce a summary report of transactions per customer
"/home/db2inst1/MASTRANC"
#Clean the data from CLIENT_JOIN2 table for the new results to be stored
db2 DELETE FROM db2inst1.CLIENT_JOIN2
#Set the input file for MASTRAND
export INFILE=RSD-/home/db2inst1/OUTPUT-INSURE.txt
#Execute MASTRAND to save the summary report of transactions per customer in CLIENT_JOIN2 table
"/home/db2inst1/MASTRAND"
