       ...
       FD OUTFILE.                                                      00230000
       01 OUTPUT-REC              PIC X(212).                           00170000
                                                                        00170000
       ...
       01 WS-CONSTANTS.                                                 00400000
          ...
          10 WS-HEADER-1          PIC X(112) VALUE                      00400000
            'CUSTOMER_ID,GENDER,AGE,HIGHEST_EDUCATION_CODE,ANNUAL_INVEST00400000
      -     'MENT_ANNUAL_INCOME,ACTIVITY_LEVEL,CHURN_CODE,CONT_ID,'.    00400000
          10 WS-HEADER-2          PIC X(100) VALUE                      00400000
            'TOTAL_TRANSACTIONS,TOTAL_TRANSACTIONS_AMOUNT,AVERAGE_TRANSA00400000
      -     'CTIONS_AMOUNT,AVERAGE_DAILY_TRANSACTIONS,'.                00400000
      ...
      *   05 WS-MAX-DATE          PIC 9(08).                            00400000
       ...
       END-PROCESS.                                                     00443715
           ...
           DISPLAY '***************************************'            00443715
           DISPLAY '* PROGRAM NAME  :    MASTRANA         *'            00443715
